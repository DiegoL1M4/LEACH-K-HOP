...
for modoOp in modosHop:
    ...
    while(len(nodes) != 0):
        ...
        if(len(CH) != 0):
            ...
            if len(nodes) != qtdNodes and firstNodeKilled == 0:
                firstNodeKilled = Round

            # Gerar arquivo com os nós atuais
            generateFile(nodes, Round, str(intraCluster) + str(interCluster))
    ...
    print('Primeiro nó: ' + str(firstNodeKilled))
    print('Total de rounds: ' + str(Round))
